...
`t3.medium`에서 `t3.large`로 변경하는 방안이 언급되었으나 확정된 변경은 아니다. `t3.large`는 vCPU는 2개로 동일하고 메모리만 4GiB에서 8GiB로 증가한다.
...
| 라이선스 방식 | 라이선스 비용(세전) | VAT 포함 비용 | 과금 성격 |
| --- | ---: | ---: | --- |
| Standard 연간 구독 4코어 | $2,836/년 | **$3,119.60/년 / 약 436.7만원** | 매년 반복 |
| Standard 영구 4코어 | $7,890 | **$8,679 / 약 1,215만원** | 첫해 일시 구매 |

연간 구독의 월 비용은 최종 통합표 계산에서만 연간 금액을 12개월로 환산한다. 영구 라이선스는 첫해에만 일시 구매 비용이 발생한다. 실제 구매가는 CSP 할인, Software Assurance, License Mobility 조건에 따라 달라진다.

## 9. 통합 예상 비용 — DB 성장별

아래 표가 앱 서버, DB 서버, EBS, 네트워크 및 SQL Server 라이선스를 모두 합산한 최종 견적이다. 모든 금액은 VAT 포함이다.

### 9.1 Standard 연간 구독 — `t3.medium`
...
### 9.2 Standard 연간 구독 — `t3.large`

| DB 증가 | 예상 DB | 권장 디스크 | 월 비용(VAT 포함) | 연 비용(VAT 포함) |
| --- | ---: | ---: | ---: | ---: |
| 현재 | 279GB | 500GB | **$671 / 약 94만원** | **$8,049 / 약 1,127만원** |
| 2배 | 557GB | 750GB | **$696 / 약 97만원** | **$8,350 / 약 1,169만원** |
| 3배 | 836GB | 1.1TB | **$731 / 약 102만원** | **$8,771 / 약 1,228만원** |
| 5배 | 1.39TB | 1.8TB | **$801 / 약 112만원** | **$9,614 / 약 1,346만원** |

### 9.3 Standard 영구 라이선스 — `t3.medium`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 현재 | 279GB | 500GB | **$13,098 / 약 1,834만원** | **$1,092 / 약 153만원** | **$368 / 약 52만원** | **$4,419 / 약 619만원** |
| 2배 | 557GB | 750GB | **$13,399 / 약 1,876만원** | **$1,117 / 약 156만원** | **$393 / 약 55만원** | **$4,720 / 약 661만원** |
| 3배 | 836GB | 1.1TB | **$13,820 / 약 1,935만원** | **$1,152 / 약 161만원** | **$428 / 약 60만원** | **$5,141 / 약 720만원** |
| 5배 | 1.39TB | 1.8TB | **$14,663 / 약 2,053만원** | **$1,222 / 약 171만원** | **$499 / 약 70만원** | **$5,984 / 약 838만원** |

### 9.4 Standard 영구 라이선스 — `t3.large`

| DB 증가 | 예상 DB | 권장 디스크 | 첫해 총액(VAT 포함) | 첫해 월 환산(참고) | 2년 차 이후 월 비용(VAT 포함) | 2년 차 이후 연 비용(VAT 포함) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 현재 | 279GB | 500GB | **$13,608 / 약 1,905만원** | **$1,134 / 약 159만원** | **$411 / 약 58만원** | **$4,929 / 약 690만원** |
| 2배 | 557GB | 750GB | **$13,909 / 약 1,947만원** | **$1,159 / 약 162만원** | **$435 / 약 61만원** | **$5,230 / 약 732만원** |
| 3배 | 836GB | 1.1TB | **$14,331 / 약 2,006만원** | **$1,194 / 약 167만원** | **$471 / 약 66만원** | **$5,652 / 약 791만원** |
| 5배 | 1.39TB | 1.8TB | **$15,173 / 약 2,124만원** | **$1,264 / 약 177만원** | **$541 / 약 76만원** | **$6,494 / 약 909만원** |

### 9.5 3배 성장 비용 구성 — `t3.medium`

#### 개별 금액

| 개별 항목 | 월 반복비용(VAT 포함) | 연간 구독 연비용(VAT 포함) | 영구 구매 첫해 비용(VAT 포함) | 영구 구매 2년 차 연비용(VAT 포함) |
| --- | ---: | ---: | ---: | ---: |
| 앱 EC2 `t3.medium` | $42.56 / 약 6만원 | $510.68 / 약 72만원 | $510.68 / 약 72만원 | $510.68 / 약 72만원 |
| 앱 EBS gp3 50GB | $5.02 / 약 0.7만원 | $60.19 / 약 8.4만원 | $60.19 / 약 8.4만원 | $60.19 / 약 8.4만원 |
| 공인 IPv4 | $4.09 / 약 0.6만원 | $49.10 / 약 6.9만원 | $49.10 / 약 6.9만원 | $49.10 / 약 6.9만원 |
| 네트워크 전송(상한) | $5.17 / 약 0.7만원 | $62.09 / 약 8.7만원 | $62.09 / 약 8.7만원 | $62.09 / 약 8.7만원 |
| DB EC2 `r7i.xlarge` | $261.23 / 약 36.6만원 | $3,134.80 / 약 438.9만원 | $3,134.80 / 약 438.9만원 | $3,134.80 / 약 438.9만원 |
| DB EBS 1.1TB | $110.35 / 약 15.4만원 | $1,324.22 / 약 185.4만원 | $1,324.22 / 약 185.4만원 | $1,324.22 / 약 185.4만원 |
| SQL Server Standard | $259.97 / 약 36.4만원 | $3,119.60 / 약 436.7만원 | $8,679 / 약 1,215만원 | — |
| **합계** | **$688.39 / 약 96만원** | **$8,260.69 / 약 1,156만원** | **$13,820.09 / 약 1,935만원** | **$5,141.09 / 약 720만원** |

#### 합계 대비 비중

| 개별 항목 | 연간 구독 | 영구 구매 첫해 | 영구 구매 2년 차 |
| --- | ---: | ---: | ---: |
| 앱 EC2 `t3.medium` | **6.18%** | **3.70%** | **9.93%** |
| 앱 EBS gp3 50GB | **0.73%** | **0.44%** | **1.17%** |
| 공인 IPv4 | **0.59%** | **0.36%** | **0.96%** |
| 네트워크 전송(상한) | **0.75%** | **0.45%** | **1.21%** |
| DB EC2 `r7i.xlarge` | **37.95%** | **22.68%** | **60.98%** |
| DB EBS 1.1TB | **16.03%** | **9.58%** | **25.76%** |
| SQL Server Standard | **37.76%** | **62.80%** | — |
| **합계** | **100.00%** | **100.00%** | **100.00%** |

### 9.6 3배 성장 비용 구성 — `t3.large`

#### 개별 금액

| 개별 항목 | 월 반복비용(VAT 포함) | 연간 구독 연비용(VAT 포함) | 영구 구매 첫해 비용(VAT 포함) | 영구 구매 2년 차 연비용(VAT 포함) |
| --- | ---: | ---: | ---: | ---: |
| 앱 EC2 `t3.large` | $85.11 / 약 12만원 | $1,021.36 / 약 143만원 | $1,021.36 / 약 143만원 | $1,021.36 / 약 143만원 |
| 앱 EBS gp3 50GB | $5.02 / 약 0.7만원 | $60.19 / 약 8.4만원 | $60.19 / 약 8.4만원 | $60.19 / 약 8.4만원 |
| 공인 IPv4 | $4.09 / 약 0.6만원 | $49.10 / 약 6.9만원 | $49.10 / 약 6.9만원 | $49.10 / 약 6.9만원 |
| 네트워크 전송(상한) | $5.17 / 약 0.7만원 | $62.09 / 약 8.7만원 | $62.09 / 약 8.7만원 | $62.09 / 약 8.7만원 |
| DB EC2 `r7i.xlarge` | $261.23 / 약 36.6만원 | $3,134.80 / 약 438.9만원 | $3,134.80 / 약 438.9만원 | $3,134.80 / 약 438.9만원 |
| DB EBS 1.1TB | $110.35 / 약 15.4만원 | $1,324.22 / 약 185.4만원 | $1,324.22 / 약 185.4만원 | $1,324.22 / 약 185.4만원 |
| SQL Server Standard | $259.97 / 약 36.4만원 | $3,119.60 / 약 436.7만원 | $8,679 / 약 1,215만원 | — |
| **합계** | **$730.95 / 약 102만원** | **$8,771.38 / 약 1,228만원** | **$14,330.78 / 약 2,006만원** | **$5,651.78 / 약 791만원** |

#### 합계 대비 비중

| 개별 항목 | 연간 구독 | 영구 구매 첫해 | 영구 구매 2년 차 |
| --- | ---: | ---: | ---: |
| 앱 EC2 `t3.large` | **11.64%** | **7.13%** | **18.07%** |
| 앱 EBS gp3 50GB | **0.69%** | **0.42%** | **1.06%** |
| 공인 IPv4 | **0.56%** | **0.34%** | **0.87%** |
| 네트워크 전송(상한) | **0.71%** | **0.43%** | **1.10%** |
| DB EC2 `r7i.xlarge` | **35.74%** | **21.87%** | **55.47%** |
| DB EBS 1.1TB | **15.10%** | **9.24%** | **23.43%** |
| SQL Server Standard | **35.57%** | **60.56%** | — |
| **합계** | **100.00%** | **100.00%** | **100.00%** |

### 9.7 최종 통합 견적표 — DB 3배 기준

| 선택지 | 월 비용(VAT 포함) | 첫해 연 비용(VAT 포함) | 2년 차 이후 연 비용(VAT 포함) |
| --- | ---: | ---: | ---: |
| Standard 연간 구독 + `t3.medium` | **$688 / 약 96만원** | **$8,261 / 약 1,156만원** | **$8,261 / 약 1,156만원** |
| Standard 연간 구독 + `t3.large` | **$731 / 약 102만원** | **$8,771 / 약 1,228만원** | **$8,771 / 약 1,228만원** |
| Standard 영구 구매 + `t3.medium` | 첫해 환산 **$1,152 / 약 161만원** | **$13,820 / 약 1,935만원** | **$5,141 / 약 720만원** |
| Standard 영구 구매 + `t3.large` | 첫해 환산 **$1,194 / 약 167만원** | **$14,331 / 약 2,006만원** | **$5,652 / 약 791만원** |
