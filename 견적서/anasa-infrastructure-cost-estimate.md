...
| 최적화 수준 | 포함 범위 | 월 추가 비용 | 예상 총 월 비용(VAT 포함) |
| --- | --- | ---: | ---: |
| 무증설 최적화 | Query Store, 실행계획, 쿼리 수정, 기존 Redis 캐시 | **$0** | **$688 / 약 96만원** |
| 인덱스 중심 | 무증설 최적화 + 인덱스용 EBS 0~300GB | **$0~30 / 약 0~4.2만원** | **약 $688~718 / 96~100만원** |
