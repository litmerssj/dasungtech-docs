...
- 반복적으로 발생하는 비용은 모든 표에서 `월 비용(VAT 포함)`과 `연 비용(VAT 포함)`을 함께 표시한다.
- 연간 구독의 월 비용은 연간 금액을 12개월로 나눈 비교용 월 환산액이다.
...
#### 3배 성장 통합 견적에 미치는 영향 — 월 비용

| 라이선스 방식 | `t3.medium` 월 비용(VAT 포함) | `t3.large` 월 비용(VAT 포함) | 월 증가액 |
| --- | ---: | ---: | ---: |
| Standard 연간 구독 | $688 / 약 96만원 | **$731 / 약 102만원** | **약 $43 / 6만원** |

#### 3배 성장 통합 견적에 미치는 영향 — 연 비용

| 라이선스 방식 | `t3.medium` 연 비용(VAT 포함) | `t3.large` 연 비용(VAT 포함) | 연 증가액 |
| --- | ---: | ---: | ---: |
| Standard 연간 구독 | $8,261 / 약 1,156만원 | **$8,771 / 약 1,228만원** | **약 $511 / 72만원** |
...
| 750GB | $75.24 / 약 10.5만원 | $902.88 / 약 126.4만원 | DB 2배 |
| 1.1TB | $110.35 / 약 15.4만원 | $1,324.22 / 약 185.4만원 | DB 3배 |
| 1.8TB | $180.58 / 약 25.3만원 | $2,166.96 / 약 303.4만원 | DB 5배 |
...
| DB 증가 | 예상 DB | 권장 디스크 | 첫해 총액(VAT 포함) | 첫해 월 환산(참고) |
| --- | ---: | ---: | ---: | ---: |
| 현재 | 279GB | 500GB | **$13,098 / 약 1,834만원** | **$1,092 / 약 153만원** |
| 2배 | 557GB | 750GB | **$13,399 / 약 1,876만원** | **$1,117 / 약 156만원** |
| 3배 | 836GB | 1.1TB | **$13,820 / 약 1,935만원** | **$1,152 / 약 161만원** |
| 5배 | 1.39TB | 1.8TB | **$14,663 / 약 2,053만원** | **$1,222 / 약 171만원** |

### 2년 차 이후 반복 비용

| DB 증가 | 권장 디스크 | 월 비용(VAT 포함) | 연 비용(VAT 포함) |
| --- | ---: | ---: | ---: |
| 현재 | 500GB | **$368 / 약 52만원** | **$4,419 / 약 619만원** |
| 2배 | 750GB | **$393 / 약 55만원** | **$4,720 / 약 661만원** |
| 3배 | 1.1TB | **$428 / 약 60만원** | **$5,141 / 약 720만원** |
| 5배 | 1.8TB | **$499 / 약 70만원** | **$5,984 / 약 838만원** |

## 10. 3배 성장 기준 비교

| 구분 | 연간 구독 | 영구 구매 |
| --- | ---: | ---: |
| 첫해 연 비용 | **$8,261 / 약 1,156만원** | **$13,820 / 약 1,935만원** |
| 2년 차 연 비용 | **$8,261 / 약 1,156만원** | **$5,141 / 약 720만원** |
| 3년 누적 비용 | **$24,782 / 약 3,469만원** | **$24,102 / 약 3,374만원** |
